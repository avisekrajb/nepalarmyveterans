      ...
      <Container>
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-md p-8 border border-gray-100 mb-8">
            <h2 className="font-display text-2xl font-bold text-army mb-6 text-center">
            ...
            <div className="space-y-4">
              ...
              <div>
                <p className="font-semibold text-army mb-2">संघको कोषमा देहायका रकमहरू हाल्न बाधिनेछन् :</p>
                <ul className="space-y-2 text-gray-700 leading-relaxed pl-6">
          ...
          <div className="bg-white rounded-2xl shadow-md p-8 border border-gray-100 mb-8">
            ...
            <p className="text-gray-600 text-center mb-6">संघको कोष चार प्रकारको हुनेछ :</p>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-gold/5 p-4 rounded-lg border border-gold/20">
                <h3 className="font-semibold text-army text-lg">अक्षय कोष</h3>
                <p className="text-sm text-gray-600 mt-1">"नेपाल राष्ट्रिय गणेश भण्डारी स्मृति अक्षय कोष"</p>
              ...
              <div className="bg-gold/5 p-4 rounded-lg border border-gold/20">
                <h3 className="font-semibold text-army text-lg">मूल कोष</h3>
                <ul className="text-sm text-gray-700 mt-2 space-y-1 pl-4">
              ...
              <div className="bg-gold/5 p-4 rounded-lg border border-gold/20">
                <h3 className="font-semibold text-army text-lg">साधारण कोष</h3>
                <ul className="text-sm text-gray-700 mt-2 space-y-1 pl-4">
              ...
              <div className="bg-gold/5 p-4 rounded-lg border border-gold/20">
                <h3 className="font-semibold text-army text-lg">कल्याणकारी कोष</h3>
                <ul className="text-sm text-gray-700 mt-2 space-y-1 pl-4">
          ...
          <div className="bg-white rounded-2xl shadow-md p-8 border border-gray-100 mb-8">
            ...
            <div className="space-y-4">
              ...
              <div>
                <p className="font-semibold text-army mb-3">अक्षय कोषको सञ्चालन उपसमिति :</p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <div className="bg-gray-50 p-3 rounded-lg border border-gray-100">
                    <p className="text-sm text-gray-600">केन्द्रीय सभापति</p>
                    <p className="font-semibold text-army">१</p>
                  </div>
                  <div className="bg-gray-50 p-3 rounded-lg border border-gray-100">
